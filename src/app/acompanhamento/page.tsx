...
import { deleteWeeklyCheckinAction, saveWeeklyCheckinAction } from "./actions";
        ...
        <GlassCard>
          ...
          <div className="mt-6 grid gap-3">
            {checkins.map((checkin) => (
              <div key={checkin.id} className="flex items-center justify-between gap-3 rounded-2xl bg-white/[0.04] p-4 text-sm text-zinc-300">
                <div>
                  <p className="font-semibold text-zinc-100">{checkin.weekStart.toLocaleDateString("pt-BR")}</p>
                  <p className="mt-1 text-zinc-400">{checkin.averageWeightKg} kg - adesao {checkin.adherencePct}%</p>
                </div>
